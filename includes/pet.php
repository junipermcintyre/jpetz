...
function getPet($db, $petId) {
    ...
    if (!$sth->bind_result($id, $name, $owner, $bio, $att, $def, $busy, $alive, $hp, $maxhp, $hunger, $maxhunger, $feeds, $flaunts, $speciesId, $species, $typeId, $type)){throw new Exception ("Bind Result failed: ".__LINE__);}
